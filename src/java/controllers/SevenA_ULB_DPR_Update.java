...
import Beans.sevenCInsertUpdate;
import Beans.sevenCUpdateBean;
 ...
 */
@WebServlet("/SevenA_ULB_DPR_Update")
public class SevenA_ULB_DPR_Update extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SevenA_ULB_DPR_Update() {
        super();
